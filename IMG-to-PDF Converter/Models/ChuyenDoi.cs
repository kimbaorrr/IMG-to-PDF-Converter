...
namespace IMG_to_PDF_Converter.Models
{
    internal class ChuyenDoi
    {
        ...
        public byte Do_Dai_Mang { get; set; }
        /// <summary>
        /// Default Constructor
        /// </summary>
        public ChuyenDoi()
        ...
        public void chuyenDoi_Tep_PDF()
        {
            try
            {
                string filePath = System.IO.Path.Combine(this.Duong_Dan_Luu_Tep, this.TenTepSauCD + ".pdf");
                ...
                using (PdfDocument pdf = new PdfDocument(writer))
                {
                    ...
                    a.Close();
                    this.ThongBao = "Chuyển đổi thành công !";
                }
            }
            catch (Exception ex)
            {
                this.ThongBao = "Quá trình chuyển đổi không thành công !\nLỗi: " + ex.Message;
